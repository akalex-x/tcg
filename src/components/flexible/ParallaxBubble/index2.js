mport styles from './ParallaxBubble.module.scss'
    ...
    return(
        <>
            <div className={styles.parallax_bubble} ref={el=>$section=el}>
                ...
                <div className={ [styles.parallax_bubble__blob, 'blob'].join(' ') }>
                ...
                <div className={ [styles.parallax_bubble__blob, 'blob'].join(' ') }>
                    ...
                    {/* <svg ref={el=>$cursor=el} version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 500 500" width="100%" id="blobSvg" opacity="1" filter="blur(10px)" transform="rotate(0)">
                        <defs>
